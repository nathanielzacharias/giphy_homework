import React, { useState, useElement } from 'react';
...
function App() {
  ...
  return (
    <div className="container">
      ...
      {/* <Form_button returnedData={returnedData} setReturnedData={setReturnedData} gifURL={gifURL} setGifURL={setGifURL} /> */}
      <button onClick={sendRequest}>Gimme random</button>

      <ShowGIF gifURL={gifURL} />
